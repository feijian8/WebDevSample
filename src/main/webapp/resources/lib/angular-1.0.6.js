...
function $SnifferProvider() {
  this.$get = ['$window', function($window) {
    ...
    return {
      ...
      // https://github.com/angular/angular-1.0.6.js/issues/904
 ...
 *
 * `ngCloak` works in cooperation with a css rule that is embedded within `angular-1.0.6.js` and
 ...
 *
 * For the best result, `angular-1.0.6.js` script must be loaded in the head section of the html file;
 ...
 * These rules are bundled with angular-1.0.6.js and the rules can be overridden
